...
public class ImgSelConfig {
     ...
     * 自定义图片加载器
     */
    public SelectImageLoader loader;
     ...
     * 已选图片路径
     */
    public ArrayList<String> originImagePath = new ArrayList<>();
    ...
    public ImgSelConfig(Builder builder) {
        ...
        this.originImagePath = builder.originImagePath;
    ...
    public static class Builder implements Serializable {
        ...
        private SelectImageLoader loader;
        private ArrayList<String> originImagePath = new ArrayList<>();
        ...
        public Builder(Context context, SelectImageLoader loader) {
            this.loader = loader;
            ...
            btnTextColor = ContextCompat.getColor(context,R.color.text_color_default);
        ...
        public Builder originImagePath(ArrayList<String> originImagePath) {
